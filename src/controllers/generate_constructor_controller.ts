...
import { GenerateConstructor } from '../commands/generate_constructor';

export const generateConstructorController = () => {
    ...
    if (editor) {
        ...
        editor.edit((editBuilder) => {
            ...
            editBuilder.insert(editor.selection.active, GenerateConstructor.exec(documentStr));
        });
    }
};